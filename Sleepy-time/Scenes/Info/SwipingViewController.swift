...
//    
//    //MARK: - Properties
//    var pages: [Page] = [Page(imageName: "bear", text: "first", isButtonActive: false), Page(imageName: "bear", text: "second", isButtonActive: false), Page(imageName: "bear", text: "third", isButtonActive: false), Page(imageName: "bear", text: "fourth", isButtonActive: true)]
//    
